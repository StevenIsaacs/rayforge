...
class RuidaDriver(Driver):
    """
    Handles Ruida-based devices via UDP or USB/Serial
    """

    label = _("Ruida")
    subtitle = _("Ruida controller via a UDP or USB/Serial connection")
        ...
        return VarSet(
            vars=[
                ...
                PortVar(
                    key="port",
                    label=_("Port"),
                    description=_("The UDP port number"),
                    default=50200,
                ),
            ]
        )
    ...
    def can_home(self, axis: Optional[Axis] = None) -> bool:
        """Ruida supports homing for all axes."""
        return True
    ...
    def can_jog(self, axis: Optional[Axis] = None) -> bool:
        """Ruida supports jogging for all axes."""
        return True
    ...
    def can_g0_with_speed(self) -> bool:
        """Ruida supports speed parameter in G0 commands."""
        return True
